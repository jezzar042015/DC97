<template>
    <div @click="handleClick"
        class="min-w-20 rounded-full flex flex-col px-3 py-3 space-y-1 items-center cursor-pointer relative overflow-hidden transition-all duration-300 active:scale-[1]">
