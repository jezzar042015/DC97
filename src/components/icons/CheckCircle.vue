    ...
    <svg viewBox="0 -0.5 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g id="SVGRepo_iconCarrier">
            <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                stroke="#0055ff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
            <path d="M9 12.0002L11.333 14.3332L16 9.66724" stroke="#0055ff" stroke-width="1.5" stroke-linecap="round"
